...
Esses componentes incluem serviços de gerenciamento, HealthTools, Controle de nuvem híbrida NetApp, software Element, nó de gerenciamento e (dependendo da sua instalação) o plug-in Element para vCenter Server.
...
Você pode usar a sequência a seguir para atualizar seu sistema de storage all-flash NetApp SolidFire para o Element 12,3.x.
